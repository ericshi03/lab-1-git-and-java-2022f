...
public class IntroLabTest {
    ...
    @Test
    public void testbalajite() {
        String expected = "Hello! My name is Tejas! " +
                "I like dogs more than cats! I like CS!";
        String actual = IntroLab.balajite("Hi!", "Tejas", false, "I like CS!");
        assertEquals(expected, actual);
    }
}
